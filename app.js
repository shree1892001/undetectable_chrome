    ...
    try {
        ...
        await page.evaluate(() => {
            ...
            if(nameField.value!="505050jar llc"){
                throw new Error(`Failed to set the value ${nameField.value}`);
            }
            lawCheckbox.click();
...
async function fillAdditionalFields(page) {
    try {
        ...
        await page.evaluate(() => {
            ...
            document.querySelector('input[name="P4_SOP_POSTAL_CODE"]').value = "11557";
            ...
            const liaility_statement=document.querySelector('input#P4_LIAB_STATEMENT_0');


            effectiveDate.click();
            Dissolution_Date.click()
            liaility_statement.click()

            document.querySelector('input#P4_ORGANIZER_NAME').value = 'Alex Englard';
            document.querySelector('input#P4_ORGANIZER_ADDR1').value = '301 Mill Road, Suite U-5';
            document.querySelector('input[name="P4_ORGANIZER_CITY"]').value = 'Hewlett';
            document.querySelector('input[name="P4_ORGANIZER_POSTAL_CODE"]').value = '11557';
            document.querySelector('input[name="P4_SIGNATURE"]').value = "alex englard";

            document.querySelector('#P4_FILER_NAME').value = 'Alex Englard';
            document.querySelector('#P4_FILER_ADDR1').value = '301 Mill Road, Suite U-5';
            document.querySelector('input[name="P4_FILER_CITY"]').value = 'Hewlett';
            document.querySelector('input[name="P4_FILER_POSTAL_CODE"]').value = '11557';
        });
    ...
    await randomSleep(180000, 22000);
}
